...
- **Title:** <span style="color: #1e3a8a;">Swe-lego: Pushing the limits of supervised fine-tuning for software issue resolving</span>  
  ...
  **Year:** 2026  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2601.01426</span>  
...
- **Title:** <span style="color: #1e3a8a;">MMFormalizer: Multimodal Autoformalization in the Wild</span>  
  ...
  **Year:** 2026  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2601.03017</span>  
...
- **Title:** <span style="color: #1e3a8a;">SwingArena: Competitive Programming Arena for Long-context GitHub Issue Solving</span>  
  ...
  **Year:** 2026  
  **Venue:** <span style="color: #92400e;">International Conference on Learning Representations (oral)</span>  
...
- **Title:** <span style="color: #1e3a8a;">Mmsearch-plus: Benchmarking provenance-aware search for multimodal browsing agents</span>  
  **Authors:** Xijia Tao, Yihua Teng, Xinxing Su, Xinyu Fu, Jihao Wu, Chaofan Tao, Ziru Liu, Haoli Bai, Rui Liu, Lingpeng Kong  
  **Year:** 2026  
  **Venue:** <span style="color: #92400e;">International Conference on Learning Representations</span>  
...
- **Title:** <span style="color: #1e3a8a;">OVD: On-policy Verbal Distillation</span>  
  ...
  **Year:** 2026  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2601.21968</span>  
...
- **Title:** <span style="color: #1e3a8a;">From Verifiable Dot to Reward Chain: Harnessing Verifiable Reference-based Rewards for Reinforcement Learning of Open-ended Generation</span>  
...
- **Title:** <span style="color: #1e3a8a;">PhyX: Does Your Model Have the "Wits" for Physical Reasoning?</span>  
  ...
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2505.15929</span>  
...
- **Title:** <span style="color: #1e3a8a;">Scaling laws with vocabulary: Larger models deserve larger vocabularies</span>  
  **Authors:** Chaofan Tao, Qian Liu, Longxu Dou, Niklas Muennighoff, Zhongwei Wan, Ping Luo, Min Lin, Ngai Wong  
  **Year:** 2024  
  **Venue:** <span style="color: #92400e;">Advances in Neural Information Processing Systems (NeurIPS-2024)</span>  
...
- **Title:** <span style="color: #1e3a8a;">ATTS: Asynchronous Test-Time Scaling via Conformal Prediction</span>  
...
- **Title:** <span style="color: #1e3a8a;">UNCOMP: Can Matrix Entropy Uncover Sparsity? - A Compressor Design from an Uncertainty-Aware Perspective</span>  
  ...
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">Proceedings of the 2025 Conference on Empirical Methods in Natural Language Processing</span>  
...
- **Title:** <span style="color: #1e3a8a;">Find your optimal teacher: Personalized data synthesis via router-guided multi-teacher distillation</span>  
  ...
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2510.10925</span>  
...
- **Title:** <span style="color: #1e3a8a;">AnchorTP: Resilient LLM Inference with State-Preserving Elastic Tensor Parallelism</span>  
  **Authors:** Wendong Xu, Chujie Chen, He Xiao, Kuan Li, Jing Xiong, Chen Zhang, Wenyong Zhou, Chaofan Tao, Yang Bai, Bei Yu, Ngai Wong  
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2511.11617</span>  
...
- **Title:** <span style="color: #1e3a8a;">Dynamic Discriminative Operations for Efficient Long-Context Inference of Large Language Models</span>  
  ...
  **Year:** 2024  
  **Venue:** <span style="color: #92400e;">The Thirteenth International Conference on Learning Representations</span>  
...
- **Title:** <span style="color: #1e3a8a;">Crossget: Cross-guided ensemble of tokens for accelerating vision-language transformers</span>  
  **Authors:** Dachuan Shi, Chaofan Tao, Anyi Rao, Zhendong Yang, Chun Yuan, Jiaqi Wang  
  **Year:** 2024  
  **Venue:** <span style="color: #92400e;">International Conference on Machine Learning</span>  
...
- **Title:** <span style="color: #1e3a8a;">Rethinking kullback-leibler divergence in knowledge distillation for large language models</span>  
  **Authors:** Taiqiang Wu, Chaofan Tao, Jiahao Wang, Runming Yang, Zhe Zhao, Ngai Wong  
  **Year:** 2024  
  **Venue:** <span style="color: #92400e;">Proceedings of the 31st International Conference on Computational Linguistics</span>  
...
- **Title:** <span style="color: #1e3a8a;">Structured pruning for efficient generative pre-trained language models</span>  
  **Authors:** Chaofan Tao, Lu Hou, Haoli Bai, Jiansheng Wei, Xin Jiang, Qun Liu, Ping Luo, Ngai Wong  
  **Year:** 2023  
  **Venue:** <span style="color: #92400e;">Findings of the Association for Computational Linguistics: ACL 2023</span>  
...
- **Title:** <span style="color: #1e3a8a;">Compression of Generative Pre-trained Language Models via Quantization</span>  
  **Authors:** Chaofan Tao, Lu Hou, Wei Zhang, Lifeng Shang, Xin Jiang, Qun Liu, Ping Luo, Ngai Wong  
  **Year:** 2022  
  **Venue:** <span style="color: #92400e;">ACL 2022 (outstanding)</span>  
...
- **Title:** <span style="color: #1e3a8a;">Autoregressive Models in Vision: A Survey</span>  
  ...
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">Transactions on Machine Learning Research (TMLR-2025)</span>  
...
- **Title:** <span style="color: #1e3a8a;">Srpo: Enhancing multimodal llm reasoning via reflection-aware reinforcement learning</span>  
  ...
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2506.01713</span>  
...
- **Title:** <span style="color: #1e3a8a;">The synergy dilemma of long-cot sft and rl: Investigating post-training techniques for reasoning vlms</span>  
  ...
  **Year:** 2025  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2507.07562</span>  
...
- **Title:** <span style="color: #1e3a8a;">NAVERO: Unlocking Fine-Grained Semantics for Video-Language Compositionality</span>  
  ...
  **Year:** 2024  
  **Venue:** <span style="color: #92400e;">arXiv preprint arXiv:2408.09511</span>  
...
- **Title:** <span style="color: #1e3a8a;">Upop: Unified and progressive pruning for compressing vision-language transformers</span>  

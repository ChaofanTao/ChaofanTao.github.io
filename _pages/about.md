...
# Biography
I am Chaofan Tao (陶超凡), a PhD candidate in The Univerisity of Hong Kong (HKU), supervised by [Prof. Ngai Wong](https://www.eee.hku.hk/~nwong/) and [Prof. Ping Luo](http://luoping.me/) . My general research interest is to understand __high-performance machine learning__ (i.e. network compression and acceleration, efficient training), and apply them for both vision and language tasks. My research papers are published in ACL/ECCV/CIKM/AAAI, .etc.
